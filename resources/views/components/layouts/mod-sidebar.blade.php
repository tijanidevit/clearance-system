<nav class="pc-sidebar">
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="{{ route('moderator.dashboard') }}" class="b-brand text-primary">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{ route('moderator.dashboard') }}" class="pc-link">
                        <span class="pc-micon">
                            <i class="ph-duotone ph-gauge"></i>
                        </span>
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{route('moderator.student.index')}}">All student</a></li>
                    </ul>
                </li>
            </ul>
        </div>
